...
enum ChartType: String, CaseIterable, Identifiable {
    ...
    var description: String {
        ...
        case .top10CountriesByClimaJusticeScore:
            return "This horizontal bar chart presents the ten countries with the highest Clima Justice scores, a composite metric that rewards low emissions combined with high vulnerability. Countries with higher scores represent climate justice ideals — nations that contribute minimally to climate change yet are highly vulnerable to its impacts. This chart highlights countries that demonstrate responsible climate stewardship through both low carbon footprints and strong resilience."
            
        case .bottom10CountriesByClimaJusticeScore:
            return "This horizontal bar chart displays the ten countries with the lowest Clima Justice scores. These countries typically combine high territorial emissions with low vulnerability, representing the worst-case scenario for climate justice. This chart highlights countries that both contribute significantly to climate change whilst being disproportionately affected by its impacts, making them priority areas for comprehensive climate intervention."
        ...
        case .climaJusticeScoreByRegion:
            return "This doughnut chart shows the total Clima Justice scores aggregated by geographical region. This metric rewards regions that combine low emissions with high vulnerability, highlighting areas that contribute positively to global climate justice. Larger sectors represent regions that collectively demonstrate responsible climate stewardship through minimal climate impact and disproportionate exposure to climate risks."
